...
if (getenv('IS_DDEV_PROJECT') == 'true' && file_exists($app_root . '/sites/default/settings.ddev.php')) {
...
# }
$databases['default']['default']['database'] = "front3";
$settings['config_sync_directory'] = $app_root . '/sites/front3/config/sync';
